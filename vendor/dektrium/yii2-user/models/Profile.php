...
class Profile extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            'employee_idLength'    => ['employee_id', 'string', 'max' => 255],
            'biometricLength'      => ['biometric', 'string', 'max' => 255],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'employee_id'    => \Yii::t('user', 'Employee ID No.'),
            'biometric'      => \Yii::t('user', 'Biometrics'),
        ];
    }
