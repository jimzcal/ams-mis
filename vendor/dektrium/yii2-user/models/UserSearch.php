...
class UserSearch extends Model
{
    ...
    {
        return [
            'fieldsSafe' => [['id', 'username', 'email', 'registration_ip', 'created_at', 'last_login_at', 'fullname', 'region'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', $table_name . '.username', $this->username])
              ...
              ->andFilterWhere(['like', $table_name . '.fullname', $this->fullname])
              ->andFilterWhere(['like', $table_name . '.region', $this->region])
