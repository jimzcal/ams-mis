    ...
    public function actionRegister()
    {
        ...
        if ($model->load(\Yii::$app->request->post()) && $model->register()) 
        {
            ...
            return $this->render('register', [
                'title'  => \Yii::t('user', 'Your account has been created but subject for approval of the Accounting Head. For immediate approval, call the Accounting Head, Sarah Charie D. Saquing'),
                'module' => $this->module,
                'model' => $model,
            ]);
            // Yii::$app->getSession()->setFlash('success', 'You have successfully created your account, but it is subject for approval by the Accounting Head. For immediate approval, call the Accounting Head, Sarah Charie D. Saquing');
