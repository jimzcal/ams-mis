...
class Projects extends \yii\db\ActiveRecord
{
    ...
    public function getOrs($project_id, $appropriation_class)
    {
        $data = Obligations::find()->where(['project_id' => $project_id])
                                    ->andFilterWhere(['like', 'ors_year', date('Y')])
    ...
    public function getObligation($ors_no, $project_id, $quarter, $appropriation_class, $operating_unit, $fund_cluster)
    {
        if($quarter == 1)
        {
            ...
            $obligations = array_sum(ArrayHelper::getColumn(Obligations::find()
                ...
                ->andWhere(['operating_unit' => $operating_unit])
                ->andWhere(['appropriation_class' => $appropriation_class])
                ->andWhere(['between', 'ors_date', date('Y-01-01'), date('Y-03-31')])
                //->andFilterWhere(['like', 'ors_date', date('Y', $date)])
                ->all(), 'amount'));
        ...
        if($quarter == 2)
        {
            $obligations = array_sum(ArrayHelper::getColumn(Obligations::find()
                ...
                ->andWhere(['operating_unit' => $operating_unit])
                ->andWhere(['appropriation_class' => $appropriation_class])
                ->andWhere(['between', 'ors_date', date('Y-04-01'), date('Y-06-30')])
                //->andFilterWhere(['like', 'ors_date', date('Y', $date)])
                ->all(), 'amount'));
        ...
        if($quarter == 3)
        {
            $obligations = array_sum(ArrayHelper::getColumn(Obligations::find()
                ...
                ->andWhere(['operating_unit' => $operating_unit])
                ->andWhere(['appropriation_class' => $appropriation_class])
                ->andWhere(['between', 'ors_date', date('Y-07-01'), date('Y-09-30')])
                //->andFilterWhere(['like', 'ors_date', date('Y', $date)])
                ->all(), 'amount'));
        ...
        if($quarter == 4)
        {
            ...
            $obligations = array_sum(ArrayHelper::getColumn(Obligations::find()
                ...
                ->andWhere(['operating_unit' => $operating_unit])
                ->andWhere(['appropriation_class' => $appropriation_class])
                ->andWhere(['between', 'ors_date', date('Y-10-01'), date('Y-12-31')])
                //->andFilterWhere(['like', 'ors_date', date('Y', $date)])
                ->all(), 'amount'));
    ...
    public function getTotalobligation($ors_no, $project_id, $appropriation_type, $operating_unit, $fund_cluster)
    {
        $total_obligations = array_sum(ArrayHelper::getColumn(Obligations::find()
                ...
                ->andWhere(['between', 'ors_date', date('Y-01-01'), date('Y-12-31')])
                //->andFilterWhere(['like', 'ors_date', date('Y', $date)])
                ->all(), 'amount'));
    ...
    public function getDisbursement($ors_no, $project_id, $quarter, $operating_unit)
    {
        if($quarter == 1)
        {
    ...
    public function getLiquidation($ors_no, $project_id, $quarter, $operating_unit)
    {
        if($quarter == 1)
        {
