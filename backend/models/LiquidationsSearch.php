...
/**
 * LiquidationsSearch represents the model behind the search form of `backend\models\Liquidations`.
 */
class LiquidationsSearch extends Liquidations
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['date_entry', 'ors_no', 'ors_date', 'ors_class', 'funding_source', 'ors_month', 'ors_serial', 'dv_no', 'dv_date', 'reference', 'status'], 'safe'],
            [['amount'], 'number'],
        ];
    }
