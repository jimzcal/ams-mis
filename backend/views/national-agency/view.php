...
<div class="national-agency-view">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div style="width: 95%; margin-right: auto; margin-left: auto; border-radius: 5px; background-color: #fff; opacity: .9; padding: 8px;">
            <?= DetailView::widget([
                'model' => $model,
                'attributes' => [
                    'id',
