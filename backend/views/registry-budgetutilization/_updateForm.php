...
<div class="registry-budgetutilization-form">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td>
                <?= $form->field($model, 'appropriation_type')->dropdownList(['Supplemental' => 'Supplemental Appropriation', 'Continuing' => 'Continuing Appropriation']) ?>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <?= $form->field($model, 'fund_cluster')->dropdownList(['01' => '01 - Regular Agency Fund', '02' => '02 - Foreign Assisted Project Fund', '03' => '03 - Special Account (Locally Assisted)', '04' => '04 - Special Account (Foreign Assisted)']) ?>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <?= $form->field($model, 'particulars')->textarea(['rows' => 10, 'style' => 'padding: 5px;']) ?>
            </td>
        </tr>
    </table>
    ...
    <table style="width: 100%" id="tbl2">
        ...
        <tr id="tbl-tr">
            ...
            <td>
                <?= $form->field($model, 'uacs[]')->textInput(['maxlength' => true, 'value' => $value->uacs])->label(false) ?>
            </td>
            <td>
